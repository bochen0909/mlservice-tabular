...
@model_endpoints("gbm/xgboost_classification")
class XGBoostClassificationModel(TabClassification):
    def __init__(self, params=None):
        ...
        if "hyperparameters" not in params:
            params["hyperparameters"] = {}
        params["hyperparameters"].setdefault('objective', 'binary:logistic')
